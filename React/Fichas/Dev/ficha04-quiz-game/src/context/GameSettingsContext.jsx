...
/**
 * Propósito: guardar preferências globais do jogo num Provider.
 * Produz/Devolve: devolve o Provider que disponibiliza nome, dificuldade, tema e funções de alteração.
 * @param {object} props - Props recebidas pelo Provider.
 * @param {React.ReactNode} props.children - Componentes que ficam dentro do contexto.
 * @returns {JSX.Element} Provider do contexto com as preferências globais.
 */
...
/**
 * Propósito: facilitar o acesso ao contexto de preferências do jogo.
 * Produz/Devolve: devolve o objeto com nome, dificuldade, tema e funções disponíveis.
 * @returns {object} Valores globais guardados no GameSettingsContext.
 */
